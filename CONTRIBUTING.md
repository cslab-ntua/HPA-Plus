...
[HPA+ Code of Conduct](https://github.com/cslab-ntua/HPA-Plus/blob/master/CODE_OF_CONDUCT.md).
...
> [Documentation](https://github.com/cslab-ntua/HPA-Plus/tree/master/docs).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/cslab-ntua/HPA-Plus/issues) that might help you. In case you
...
- Open an [Issue](https://github.com/cslab-ntua/HPA-Plus/issues/new).
...
[documentation](https://github.com/cslab-ntua/HPA-Plus/tree/master/docs). If you are looking for
support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
is not already a bug report existing for your bug or error in the
[bug tracker](https://github.com/cslab-ntua/HPA-Plus/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/cslab-ntua/HPA-Plus/issues/new). (Since we can't be
...
This section guides you through submitting an enhancement suggestion for HPA+,
...
- Read the [documentation](https://github.com/cslab-ntua/HPA-Plus/tree/master/docs) carefully and find
out if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/cslab-ntua/HPA-Plus/issues) to see if the
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/cslab-ntua/HPA-Plus/issues).

- Use a **clear and descriptive title** for the issue to identify the suggestion.
- Provide a **step-by-step description of the suggested enhancement** in as many details as possible.
- **Describe the current behavior** and **explain which behavior you expected to see instead** and why. At this point
you can also tell which alternatives do not work for you.
- **Explain why this enhancement would be useful** to most HPA+ users. You may also
